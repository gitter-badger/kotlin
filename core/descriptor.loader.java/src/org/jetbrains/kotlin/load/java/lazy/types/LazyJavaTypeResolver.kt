...
class LazyJavaTypeResolver(
    ...
    private inner class LazyJavaClassifierType(
        ...
        override fun computeTypeConstructor(): TypeConstructor {
            ...
            return when (classifier) {
                is JavaClass -> {
                    ...
                    val classData = javaToKotlinClassMap.mapKotlinClassConsideringKClassInAnnotation(fqName)
        ...
        private fun JavaToKotlinClassMap.mapKotlinClassConsideringKClassInAnnotation(fqName: FqName): ClassDescriptor? {
            ...
            val howThisTypeIsUsedEffectively = when {
                ...
                mapPlatformClass(fqName).isEmpty() -> attr.howThisTypeIsUsed

                // Read (possibly external) annotations
                else -> attr.howThisTypeIsUsedAccordingToAnnotations
            }

            return mapKotlinClass(fqName, howThisTypeIsUsedEffectively)
        }
