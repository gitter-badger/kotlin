...
public class QuickFixRegistrar {
    public static void registerQuickFixes() {
        ...
        QuickFixes.factories.put(ErrorsJvm.JAVA_LANG_CLASS_ARGUMENT_IN_ANNOTATION, ReplaceJavaClassAsAnnotationArgumentWithKClassFix.Companion);
        QuickFixes.factories.put(ErrorsJvm.JAVA_LANG_CLASS_ARGUMENT_IN_ANNOTATION, ReplaceJavaClassAsAnnotationArgumentWithKClassInWholeProjectFix.Companion);
    }
}
