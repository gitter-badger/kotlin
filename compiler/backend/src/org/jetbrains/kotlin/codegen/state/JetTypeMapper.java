...
public class JetTypeMapper {
    ...
    public Type mapAnnotationParameterType(@NotNull PropertyDescriptor descriptor) {
        //noinspection ConstantConditions
        return mapType(descriptor.getReturnType(), null, JetTypeMapperMode.VALUE_FOR_ANNOTATION);
    }
    ...
    private Type mapType(
        ...
        if (descriptor instanceof ClassDescriptor) {
            ...
            if (kind.isForAnnotation() && DescriptorUtils.isKClass((ClassDescriptor) descriptor)) {
                if (signatureVisitor != null) {
